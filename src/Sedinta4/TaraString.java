...
import static Sedinta4.Limbi.GERMANA;
import static Sedinta4.Limbi.ENGLEZA;
import static Sedinta4.Limbi.FRANCEZA;
import static Sedinta4.Limbi.ITALIANA;
...
public class TaraString {
    ...
    public TaraString(double hdi, String numeTara) {
        this.hdi = hdi;
        this.numeTara = numeTara;
        this.statusTara = " ";
    }

    public TaraString(int populatie, double PIB, double hdi, String limba, String numeTara) {
    ...
    public String updateStatusByLanguage() {
        ...
        //am inlocuit cu un string valoarea din enum, limba fiind string acum el poate fi comparat cu un string
        //nu cu un enum
        if (this.limba.equals("GERMANA")) {
            setStatusTara("ULTRA HIGH DEVELOPED");
        } else if (this.limba.equals("ITALIANA") || this.limba.equals("SPANIOLA")) {
            setStatusTara("Medium developed");
        } else if (this.limba.equals("ROMANA") || this.limba.equals("ENGLEZA")) {
...
class MainTaraString {
    public static void main(String[] args) {
        ...
        TaraString tara = new TaraString(9.6, "Zimbabwe");
        ...
        Tara tara2 = new Tara(2000000000, 8999999.2134 ,8.5, ENGLEZA, "ARGENTINA");
